...
def get_cams_eac4(dir_data,year,month,days_mon,stat,lat,lon,dxy=0.75):
    ...
    'cams-global-reanalysis-eac4',
    {
        'format': 'netcdf',
        'variable': [
            '10m_u_component_of_wind', '10m_v_component_of_wind', '2m_temperature', 'black_carbon_aerosol_optical_depth_550nm', 'dust_aerosol_optical_depth_550nm',
            'organic_matter_aerosol_optical_depth_550nm', 'particulate_matter_10um', 'particulate_matter_1um',
            'particulate_matter_2.5um', 'surface_pressure', 'total_aerosol_optical_depth_1240nm',
            ...
            'ozone','carbon_monoxide','temperature',
            'total_column_carbon_monoxide', 'total_column_methane', 'total_column_ozone', 'total_column_water_vapour',
        ],
        'time': [
            '00:00', '03:00', '06:00',
            '09:00', '12:00', '15:00',
        ...
        'date': '{y}-{m}-{d1}/{y}-{m}-{d2}'.format(y=year,m=month,d1='01',d2=days_mon), ##Normally it should ignore non-existing days (e.g. 31.February), so that I can just put 31, but for unknown reason it saves then the first days of the following month!!??
          
    },
    
    f'{dir_data}\EAC4\cams_eac4_{year}_{month}_{stat}.zip') #contains 2 files, one with plevels, one single-level file
...
#%%
def main(dir_data = r"..\..\Data\CAMS",yr1=2020, yr2=2023,which='cams_egg4',station=['MKN'],):
    '''
